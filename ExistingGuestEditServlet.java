...
/**
 * Servlet implementation class ExistingGuestEditServlet
 */
@WebServlet("/ExistingGuestEditServlet")
public class ExistingGuestEditServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExistingGuestEditServlet() {
        super();
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				String r="postgres";int n=0,i=0,m=0;
				...
				ResultSet rs3=st3.executeQuery("select admin_id from users");
				while(rs3.next())
				{
					n=rs3.getInt(1);
				}
				...
				//get id from temp
				Connection con6=DriverManager.getConnection(url,r,pass); 
				Statement st6=con6.createStatement();
				String sql6="select admin_id from temp";
				ResultSet rs6=st6.executeQuery(sql6);
				if(rs6.next())
			       m=rs6.getInt(1);
				String sqlu="delete from Votes where admin_id='"+m+"'";
